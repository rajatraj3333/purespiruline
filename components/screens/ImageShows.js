...
const ImageShows = ({dotssize,imgs}) => {
...
<Image source={{uri:item}} style={{height:Dimensions.get('screen').height*25/100,width:Dimensions.get('screen').width,resizeMode:'contain',marginTop:0}}/>
